...
**FireStrike** is an interactive 3D game that is in First Person Shooter(FPS) mode and the goal of the player is to survive before being attacked by enemies by shooting them before being spotted.
